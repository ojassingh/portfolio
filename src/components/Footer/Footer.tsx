      ...
      <div className="flex flex-wrap gap-6 text-slate-500 justify-between pt-6">
        ...
        <div className="grid gap-2">
          ...
          <div className="flex gap-2 items-center dark:text-white text-black">
            ...
            <Link href="https://github.com/ojassingh" target="_blank" className="flex gap-1 items-center">
              <Github className="size-4" /> GitHub
            </Link>
            <Link href="https://x.com/ojassinghh" target="_blank" className="flex gap-1 items-center">
